...
var callLogin = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          password = document.getElementsByTagName("input")[1].value; // console.log(email, password)
          _context.prev = 3;
          _context.next = 6;
  ...
  return function callLogin(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.callLogin = callLogin;
},{"axios":"../../node_modules/axios/index.js"}],"map.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"updateform.js":[function(require,module,exports) {
"use strict";
...
var updateForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var longitude, lattitude, type, similarity, frequency, data, config, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
  ...
  return function updateForm(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.updateForm = updateForm;
},{"axios":"../../node_modules/axios/index.js"}],"navigator.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var pgtitle = document.getElementsByTagName('title')[0].id;
if (pgtitle == 'login') {
  ...
  document.getElementById('loginbutton').addEventListener("click", _login.callLogin);
}
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            map = new mapboxgl.Map(_objectSpread(_objectSpread({
              container: 'map',
              style: 'mapbox://styles/nileshnkc/clg9ddpx2002y01p9ajlcjg9v'
            }, centerlocation), {}, {
              zoom: 1
            }));
            map.flyTo(_objectSpread(_objectSpread({}, centerlocation), {}, {
            ...
            if (data.status == 'success') {
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  feature = _step.value;
                  score = feature.score;
                  coordinates = feature.location.coordinates; // console.log(score)
